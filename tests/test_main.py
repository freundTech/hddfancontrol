...
class TestDrive(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with unittest.mock.patch.object(hddfancontrol.os, "stat") as os_stat_mock, unittest.mock.patch(
            "hddfancontrol.stat"
        ) as stat_mock, unittest.mock.patch.object(
            hddfancontrol.subprocess, "check_output"
        ) as subprocess_check_output_mock, unittest.mock.patch.object(
            hddfancontrol.Drive, "getPrettyName"
        ) as drive_getPrettyName, unittest.mock.patch.object(
    ...
    def test_getPrettyName(self):
        ...
        with unittest.mock.patch.object(hddfancontrol.subprocess, "check_output") as subprocess_check_output_mock:
...
""".lstrip()
    ...
    def test_spinDown(self):
        """Test HDD spin down."""
        with unittest.mock.patch.object(hddfancontrol.subprocess, "check_call") as subprocess_check_call_mock:
            self.drive.spinDown()
